...
//Generates Fullfill,pending and rejected action types
export const updateUserProfile = createAsyncThunk(
  //actionName,callback fn that creates payload
  "auth/updateProfile",
  async (
    {
      id,
    ...
    try {
      ...
      const { password: _, ...updatedUser } = users[userIndex]; //destructure and return user without pass
...
const authSlice = createSlice({
  ...
  //the reducer that are not generated by the slice have to be add by extra reducers
